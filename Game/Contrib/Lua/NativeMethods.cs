...
namespace Lua
{
	internal static unsafe class NativeMethods
	{
...
#else
        private const string LIBNAME = "lua53";
#endif
		...
		[DllImport (LIBNAME, CallingConvention = CallingConvention.Cdecl)]
		internal static extern byte* lua_typename (IntPtr L, int type);
		...
		[DllImport (LIBNAME, CallingConvention = CallingConvention.Cdecl)]
		internal static extern byte* lua_tolstring (IntPtr L, int index, out IntPtr strLen);

		[DllImport(LIBNAME, CallingConvention = CallingConvention.Cdecl)]
		internal static extern byte* luaL_tolstring(IntPtr L, int index, out IntPtr strLen);

        [DllImport(LIBNAME, CallingConvention = CallingConvention.Cdecl)]
        internal static extern byte* lua_pushstring(IntPtr L, byte* str);

        [DllImport (LIBNAME, CallingConvention = CallingConvention.Cdecl)]
		internal static extern byte* lua_pushlstring (IntPtr L, byte* str, IntPtr size);
		...
		[DllImport(LIBNAME, CallingConvention = CallingConvention.Cdecl)]
		internal static extern int lua_dump(IntPtr L, IntPtr writer, IntPtr data, int strip);
    }
}
